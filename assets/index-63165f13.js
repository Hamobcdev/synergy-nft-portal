import{V as m,X as d,Y as w,l as f,m as v,x as b}from"./index-3579674b.js";import{r as u,c as h}from"./if-defined-4cc63104.js";const e=m({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),s={state:e,subscribe(o){return d(e,()=>o(e))},subscribeKey(o,t){return w(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},x=f`
  :host {
    pointer-events: none;
  }
